...
import { NavigationBar, Route } from "./components/layout/NavigationBar";
...
import { createInitialBackup } from "./components/utils/createInitialBackup";
import { 
  HomeIcon, 
  ShoppingCartIcon, 
  RocketIcon, 
...
// Update type definitions in window object
declare global {
  interface Window {
  ...
  const getNavItems = () => {
    ...
    if (user?.role === "startup") {
      ...
      return [
        ...commonItems,
        { 
          route: "support-structure-dashboard", 
          label: "Dashboard", 
          icon: BuildingIcon, 
          color: "bg-chart-4",
