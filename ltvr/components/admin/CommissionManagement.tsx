          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between mt-4">
                  <Progress value={commissionSummary.pendingPayouts / commissionSummary.totalCommissions * 100} className="h-1.5" />
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between mt-4">
                  <Progress value={commissionSummary.processedPayouts / commissionSummary.totalCommissions * 100} className="h-1.5" />
                  <span className="text-xs text-muted-foreground ml-2">
